...
#Todo: Vérifier l'accès en r/w des fichiers .csv et .pdf
#Todo: Si on a le temps, créer une classe JSON decoder pour importer des parametres en .test. J'ai des exemples vu j'ai bien fini le TP dessus. C'est vraiment pas long
