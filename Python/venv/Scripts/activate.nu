...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\gross\Github\Code_learning\Python\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\gross\Github\Code_learning\Python\venv\Scripts\deactivate.nu'
